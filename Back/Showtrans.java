...
public class Showtrans {
    ...
    private ArrayList<Double> creditor_money ;
    private ArrayList<Double> deptor_money ;


    //Alternative constructor method in case there's only one transaction

    public Showtrans (Integer id,String transName, int type, Double transAmount, Long date,ArrayList<Member> creditor,ArrayList<Member> deptor,ArrayList<Double> creditor_money,ArrayList<Double> deptor_money){
        mTransID = id;
    ...
    public ArrayList<Double> getCreditor_money(){
        return this.creditor_money;
    }
    public ArrayList<Double> getDeptor_money(){
