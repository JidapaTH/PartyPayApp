...
public class Transaction {
    ...
    public ArrayList<Double> credit_money;
    public ArrayList<Double> dept_money;
    public int date;
    public String memo;
    //Constructor
    public Transaction(int id, int event_id_link, String name, int type, double amount, ArrayList<Integer> creditor,ArrayList<Double> credit_money,
                       ArrayList<Integer> deptor,ArrayList<Double> dept_money, int date,String memo) {
        this.id = id;
